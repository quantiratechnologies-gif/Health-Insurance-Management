          ...
          <TabsContent value="types">
            <Card>
              ...
              <CardContent className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <Card className="bg-slate-50 border-l-4 border-l-red-500">
                  <CardContent className="p-6">
            ...
            <Card>
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <Card className="bg-slate-50"><CardContent className="p-4 text-sm"><strong>Submit missing documents</strong> like discharge summary, original bills, or lab reports.</CardContent></Card>
                  <Card className="bg-slate-50"><CardContent className="p-4 text-sm"><strong>Verify details:</strong> Ensure all customer demographic and policy details match correctly.</CardContent></Card>
                  <Card className="bg-slate-50"><CardContent className="p-4 text-sm"><strong>Doctor Justification:</strong> Provide additional clinical notes proving medical necessity.</CardContent></Card>
                  <Card className="bg-slate-50"><CardContent className="p-4 text-sm"><strong>Correct Billing:</strong> Have the hospital correct billing mistakes and resubmit the claim.</CardContent></Card>
                </div>
              </CardContent>
            </Card>
          </TabsContent>
              ...
              <CardContent className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <Card className="border-green-200 overflow-hidden">
                  <div className="bg-green-50 p-4 border-b border-green-100 flex justify-between items-center">
                    ...
                    <Badge variant="outline" className="bg-green-100 text-green-700 hover:bg-green-200 border-none">CASHLESS</Badge>
                  </div>
                  <CardContent className="p-6">
                ...
                <Card className="border-red-200 overflow-hidden">
                  <div className="bg-red-50 p-4 border-b border-red-100 flex justify-between items-center">
                    ...
                    <Badge variant="outline" className="bg-red-100 text-red-700 hover:bg-red-200 border-none">REIMBURSEMENT</Badge>
                  </div>
                  <CardContent className="p-6">
                    <div className="grid grid-cols-2 text-xs text-slate-600 mb-6 gap-y-2">
                      <div><strong>Patient:</strong> Vempati Vamshi Krishna</div>
                    ...
                    <Card className="bg-red-50 border-red-200 text-red-800 mb-6">
              ...
              <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                  <Card className="bg-blue-50 border-blue-100 mb-6">
                    <CardContent className="p-6 text-blue-900 font-medium text-sm">
