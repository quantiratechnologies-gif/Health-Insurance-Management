                      ...
                      <TableCell>
                        {claim.status === 'Flagged' ? (
                          <div className="flex gap-2">
                            <Button size="sm" onClick={() => resolveClaim(claim.id, 'Approve')} className="bg-green-600 hover:bg-green-700 text-white cursor-pointer">Approve</Button>
                            <Button size="sm" onClick={() => resolveClaim(claim.id, 'Reject')} variant="destructive" className="cursor-pointer">Reject</Button>
                          </div>
                        ) : (
